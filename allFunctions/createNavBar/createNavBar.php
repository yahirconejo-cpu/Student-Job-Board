        ...
        <div id="navBar">
            <div id="largeNav">
                <div id="navButtons">
                    ...
                    <div '. ( "settings" == $currentPage ? $currentLargeNavDiv : $notCurrentLargeNavDiv) .'><a href="../Settings">Settings</a></div>
                </div>
            </div>
            <div id="smallNav">
                <div id="burgerNav">
            ...
            <div id="overlayContainer">
                <div id="burgerOverlay">
                    ...
                    <a href="../Settings/"><div '. ( "settings" == $currentPage ? $currentSmallNavDiv : '') .'>Settings</div></a>
                </div>
            </div>
        </div>
        ';
